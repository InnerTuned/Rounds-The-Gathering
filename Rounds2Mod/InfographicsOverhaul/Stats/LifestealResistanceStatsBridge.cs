...
/// <summary>Reads lifesteal resistance from ShieldsMod via reflection (soft dependency).</summary>
internal static class LifestealResistanceStatsBridge
{
    ...
    private static void Resolve()
    {
        ...
        try
        {
            ...
            var type = asm.GetType("ShieldsMod.Lifesteal.LifestealResistanceManager");
            if (type == null)
                return;
